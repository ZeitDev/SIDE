...
for mode in ['train', 'val', 'test']:
    ...
    for target_subset in target_subsets:
        ...
        for selected_file_name in selected_file_names:
            ...
            source_teacher_segmentation = (source_teacher_segmentation_path / selected_file_name.name.replace('.png', '.pt')).read_bytes()
            ...
            target_teacher_segmentation_path.write_bytes(source_teacher_segmentation)
