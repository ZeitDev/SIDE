...
# %% Figure 1 - Dumbbell Plot: Absolute Scores Overview
...
save_figure(fig_dumb, name='H01_F01_dumbbell_overview', lrtb_margin=(40, 20, 20, 60), folder='results', skip_sync=skip_sync)

# %% Figure 2 - Heatmap: Configuration Deltas relative to Single-Task (ST)
...
save_figure(fig_heat, name='H01_F02_heatmap_configuration_deltas', lrtb_margin=(40, 20, 20, 20), folder='results', skip_sync=skip_sync)


# %% Figure 3 - Box Plots: Configuration Stability
from plotly.subplots import make_subplots
...
save_figure(fig_box, name='H01_F03_boxplot_configuration_stability', lrtb_margin=(40, 0, 20, 0), folder='results', skip_sync=skip_sync)
