...
CHART_CONFIG = {
    'H02F01': {
        'y1': dict(range=[0, 60], dtick=10),
        'y2': dict(range=[60, 0], dtick=10),
    },
    'H02F02': {},
    'H02F03': {
        'x1': dict(range=[35, 60], dtick=5),
        'x2': dict(range=[20, 5], dtick=5),
    },
    'H02F04': {}
}
...
# %% H02T01_Table_GlobalResultsMatrix (DICE, AbsRel, Bad3)
# H02T01_Table_GlobalResultsMatrix (DICE, AbsRel, Bad3)
...
# %% H02F01_Boxplot_StabilityOverview (ST vs. MT vs. MT-KD across all Experiments)
# H02F01_Boxplot_StabilityOverview (ST vs. MT vs. MT-KD across all Experiments)
...
apply_chart_config(fig_box, 'H02F01', CHART_CONFIG)
save_figure(fig_box, height=600, name='H02F01', lrtb_margin=(40, 20, 20, 40), folder='results', skip_sync=skip_sync)

# %% H02F02_Heatmap_ConfigComparisonOverview (ST vs. MT vs. MT-KD Delta)
# H02F02_Heatmap_ConfigComparisonOverview (ST vs. MT vs. MT-KD Delta)
...
apply_chart_config(fig_heat, 'H02F02', CHART_CONFIG)
save_figure(fig_heat, name='H02F02', lrtb_margin=(40, 20, 20, 20), folder='results', skip_sync=skip_sync)

# %% H02F03_Dumbbell_ConfigComparisonOverview (ST vs. MT vs. MT-KD)
# H02F03_Dumbbell_ConfigComparisonOverview (ST vs. MT vs. MT-KD)
...
apply_chart_config(fig_dumb, 'H02F03', CHART_CONFIG)
save_figure(fig_dumb, name='H02F03', lrtb_margin=(40, 20, 20, 60), folder='results', skip_sync=skip_sync)


# %% H02F04_Heatmap_AblationComparisonOverview (Exp01 vs. ...)
# H02F04_Heatmap_AblationComparisonOverview (Exp01 vs. ...)
...
apply_chart_config(fig_heat_abl, 'H02F04', CHART_CONFIG)
save_figure(fig_heat_abl, name='H02F04', lrtb_margin=(40, 20, 20, 20), folder='results', skip_sync=skip_sync)
